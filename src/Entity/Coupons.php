...
class Coupons
{
    ...
    public function getMadUsage(): ?int
    {
        return $this->mad_usage;
    }

    public function setMadUsage(int $mad_usage): static
    {
        $this->mad_usage = $mad_usage;
